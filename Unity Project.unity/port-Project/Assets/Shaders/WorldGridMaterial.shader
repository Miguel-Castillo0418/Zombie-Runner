...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) / ((MaterialFloat2)2.00000000));
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) / ((MaterialFloat2)0.05000000));
	MaterialFloat Local3 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 1);
	MaterialFloat4 Local4 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local5 = MaterialStoreTexSample(Parameters, Local4, 1);
	MaterialFloat3 Local6 = (Local4.rgb * MaterialFloat3(0.30000001,0.30000001,1.00000000));
	...
	MaterialFloat2 Local8 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)20.00000000));
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local8), 0);
	MaterialFloat4 Local10 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local8),View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 0);
	MaterialFloat Local12 = lerp(0.40000001,1.00000000,Local10.r);
	MaterialFloat Local13 = (1.00000000 - Local12);
	MaterialFloat2 Local14 = (DERIV_BASE_VALUE(Local1) / ((MaterialFloat2)0.10000000));
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local14), 0);
	MaterialFloat4 Local16 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local14),View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 0);
	MaterialFloat Local18 = GetPixelDepth(Parameters);
	MaterialFloat Local19 = DERIV_BASE_VALUE(Local18).r;
	MaterialFloat Local20 = (DERIV_BASE_VALUE(Local19) - 24.00000000);
	MaterialFloat Local21 = (DERIV_BASE_VALUE(Local20) / 1500.00000000);
	MaterialFloat Local22 = saturate(DERIV_BASE_VALUE(Local21));
	MaterialFloat Local23 = lerp(Local16.g,1.00000000,DERIV_BASE_VALUE(Local22));
	MaterialFloat Local24 = lerp(Local12,Local13,Local23);
	MaterialFloat Local25 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local26 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local27 = MaterialStoreTexSample(Parameters, Local26, 0);
	MaterialFloat Local28 = lerp(Local16.g,0.00000000,DERIV_BASE_VALUE(Local22));
	MaterialFloat Local29 = (Local26.g + Local28);
	MaterialFloat Local30 = lerp(Local29.r,0.50000000,0.50000000);
	MaterialFloat Local31 = lerp(0.29499999,0.66000003,Local30);
	MaterialFloat Local32 = (Local31 * 0.50000000);
	MaterialFloat Local33 = (Local24 * Local32);
	MaterialFloat Local34 = lerp(0.00000000,0.50000000,Local26.g);
	MaterialFloat Local35 = lerp(0.69999999,1.00000000,Local16.g);
	MaterialFloat Local36 = lerp(Local35,1.00000000,DERIV_BASE_VALUE(Local22));
	MaterialFloat Local37 = (Local34 + Local36);
	...
	PixelMaterialInputs.Roughness = Local38;
