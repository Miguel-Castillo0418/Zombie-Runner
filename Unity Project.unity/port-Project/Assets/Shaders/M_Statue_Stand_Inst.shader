Shader "Unreal/M_Statue_Stand_Inst"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Statue_Stand_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Statue_Stand_A", 2D ) = "white" {}
		Material_Texture2D_2( "T_Statue_Stand_C", 2D ) = "white" {}
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local9 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
