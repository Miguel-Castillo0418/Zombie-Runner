Shader "Unreal/M_Skeleton_Dirty"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Skeleton_Clean_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Skeleton_Dirty_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_Skeleton_Clean_A", 2D ) = "white" {}
		Material_Texture2D_3( "T_Skeleton_Dirty_A", 2D ) = "white" {}
		Material_Texture2D_4( "T_Skeleton_Clean_C", 2D ) = "white" {}
		Material_Texture2D_5( "T_Skeleton_Dirty_C", 2D ) = "white" {}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local5 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 2);
	MaterialFloat4 Local7 = Parameters.VertexColor;
	MaterialFloat Local8 = DERIV_BASE_VALUE(Local7).r;
	MaterialFloat3 Local9 = lerp(Local2.rgb,Local5.rgb,DERIV_BASE_VALUE(Local8));

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local9.rgb;
	...
	MaterialFloat3 Local10 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local15 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local16 = MaterialStoreTexSample(Parameters, Local15, 0);
	MaterialFloat3 Local17 = lerp(Local12.rgb,Local15.rgb,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local19 = Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local20 = MaterialStoreTexSample(Parameters, Local19, 4);
	MaterialFloat Local21 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local22 = Texture2DSampleBias(Material_Texture2D_5,Material_Texture2D_5Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local23 = MaterialStoreTexSample(Parameters, Local22, 1);
	MaterialFloat Local24 = lerp(Local19.r,Local22.r,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local25 = lerp(Local19.g,Local22.g,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local26 = lerp(Local19.b,Local22.b,DERIV_BASE_VALUE(Local8));

	PixelMaterialInputs.EmissiveColor = Local10;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local17.rgb;
	PixelMaterialInputs.Metallic = Local24.rrr;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local25.rrr;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local9.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local26.rrr;
