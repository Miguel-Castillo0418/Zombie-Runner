Shader "Unreal/M_Doorway_Large_Right_Door_Inst"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Normal_Map", 2D ) = "white" {}
		Material_Texture2D_1( "Albedo_Map", 2D ) = "white" {}
		Material_Texture2D_2( "Compact_Map", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.100000,0.100000,0.100000,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.100000,0.100000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,1.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(3.000000,0.000000,0.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[1].w));
	...
	MaterialFloat3 Local5 = (Material.PreshaderBuffer[2].xyz * Local3.rgb);
	...
	MaterialFloat3 Local7 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[3].xyz,Material.PreshaderBuffer[2].w);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 2);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 2);
	MaterialFloat3 Local11 = (Local9.rgb * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local13 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 0);
	MaterialFloat Local15 = lerp(Material.PreshaderBuffer[4].z,Material.PreshaderBuffer[4].y,Local13.g);
	MaterialFloat Local16 = saturate(Local15);
	MaterialFloat Local17 = lerp(Material.PreshaderBuffer[5].x,Material.PreshaderBuffer[4].w,Local16.r);
	MaterialFloat Local18 = (1.00000000 - Local17);
	MaterialFloat Local19 = lerp(Material.PreshaderBuffer[5].z,Material.PreshaderBuffer[5].y,Local16.r);
	MaterialFloat Local20 = (Local13.b * Material.PreshaderBuffer[5].w);
	MaterialFloat2 Local21 = GetPixelPosition(Parameters);
	MaterialFloat Local22 = View.TemporalAAParams.x;
	MaterialFloat2 Local23 = (Local21 + MaterialFloat2(Local22,Local22));
	MaterialFloat Local24 = CustomExpression0(Parameters,Local23);
	MaterialFloat2 Local25 = (Local21 / MaterialFloat2(64.00000000,64.00000000));
	MaterialFloat Local26 = MaterialStoreTexCoordScale(Parameters, Local25, 3);
	MaterialFloat4 Local27 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,Local25,View.MaterialTextureMipBias));
	MaterialFloat Local28 = MaterialStoreTexSample(Parameters, Local27, 3);
	MaterialFloat Local29 = (Local24 + Local27.r);
	MaterialFloat Local30 = (Local29 * 0.16665000);
	MaterialFloat Local31 = (0.50000000 + Local30);
	MaterialFloat Local32 = (Local31 + -0.50000000);
	MaterialFloat Local33 = (Local32 * Material.PreshaderBuffer[6].x);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local11;
	PixelMaterialInputs.Metallic = Local13.r;
	PixelMaterialInputs.Specular = Local18;
	PixelMaterialInputs.Roughness = Local19;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local6;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local20;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Local33;
