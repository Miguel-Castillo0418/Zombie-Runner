Shader "Unreal/M_StoneWall_Inst"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.000000,3.000000,0.030000);//(Unknown)
}
