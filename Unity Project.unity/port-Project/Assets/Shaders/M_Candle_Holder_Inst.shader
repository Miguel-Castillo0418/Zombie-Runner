Shader "Unreal/M_Candle_Holder_Inst"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.000000,1.000000,0.342040,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local18 = lerp(Material.PreshaderBuffer[5].z,Material.PreshaderBuffer[5].y,Local16.r);
	MaterialFloat Local19 = (Local13.b * Material.PreshaderBuffer[5].w);
	...
	MaterialFloat Local28 = (Local23 + Local26.r);
	MaterialFloat Local29 = (Local28 * 0.16665000);
	MaterialFloat Local30 = (0.50000000 + Local29);
	MaterialFloat Local31 = (Local30 + -0.50000000);
	MaterialFloat Local32 = (Local31 * Material.PreshaderBuffer[6].x);
	...
	PixelMaterialInputs.Specular = Local17;
	PixelMaterialInputs.Roughness = Local18;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local6;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local19;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Local32;
