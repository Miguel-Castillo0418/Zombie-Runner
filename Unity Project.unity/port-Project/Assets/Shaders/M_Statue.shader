Shader "Unreal/M_Statue"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Statue_Hooded_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Statue_Hooded_A", 2D ) = "white" {}
		Material_Texture2D_2( "T_Statue_Hooded_R", 2D ) = "white" {}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local9 = ProcessMaterialGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Roughness = Local9.rgb;
