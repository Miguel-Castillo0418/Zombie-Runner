Shader "Unreal/M_BrickFloor_Clean_Inst"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "NormalMap", 2D ) = "white" {}
		Material_Texture2D_1( "AlbedoMap", 2D ) = "white" {}
		Material_Texture2D_2( "Compact", 2D ) = "white" {}
		Material_Texture2D_3( "HeightMap", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(3.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.800000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,-1.939510,2.000000,0.020000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = (Local7.rgb * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 3);
	MaterialFloat4 Local11 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 3);
	MaterialFloat Local13 = lerp(Material.PreshaderBuffer[3].y,Material.PreshaderBuffer[3].x,Local11.g);
	MaterialFloat Local14 = (1.00000000 - Local13);
	MaterialFloat3 Local15 = mul((MaterialFloat3x3)(Parameters.TangentToWorld), Parameters.CameraVector);
	MaterialFloat2 Local16 = (Local15.rg * ((MaterialFloat2)-1.00000000));
	MaterialFloat2 Local17 = (Local16 / ((MaterialFloat2)Local15.b));
	MaterialFloat2 Local18 = (((MaterialFloat2)Material.PreshaderBuffer[3].w) * Local17);
	MaterialFloat2 Local19 = (Local18 * ((MaterialFloat2)-1.00000000));
	MaterialFloat2 Local20 = (DERIV_BASE_VALUE(Local1) + Local19);
	MaterialFloat Local21 = dot(Parameters.CameraVector,Parameters.TangentToWorld[2]);
	MaterialFloat Local22 = abs(Local21);
	MaterialFloat Local23 = saturate(Local22);
	MaterialFloat Local24 = lerp(32.00000000,8.00000000,Local23);
	MaterialFloat Local25 = floor(Local24);
	MaterialFloat Local26 = (1.00000000 / Local24);
	MaterialFloat2 Local27 = (Local18 * ((MaterialFloat2)Local26));
	MaterialFloat2 Local28 = ddx((float2)Local20);
	MaterialFloat2 Local29 = ddy((float2)Local20);
	MaterialFloat4 Local30 = CustomExpression0(Parameters,Material_Texture2D_3,Material_Texture2D_3Sampler,Local20,Local25,Local26,Local27,Local28,Local29,MaterialFloat4(1.00000000,0.00000000,0.00000000,0.00000000));
	MaterialFloat Local31 = (1.00000000 - Local30.b);
	MaterialFloat Local32 = (Local31 * Material.PreshaderBuffer[3].w);
	MaterialFloat3 Local33 = (MaterialFloat3(Local30.rg,Local32) - ((MaterialFloat3)0.00000000));
	MaterialFloat Local34 = length(Local33);
	MaterialFloat2 Local35 = abs(Local28);
	MaterialFloat2 Local36 = (Local35 - ((MaterialFloat2)0.00000000));
	MaterialFloat Local37 = length(Local36);
	FLWCVector3 Local38 = GetWorldPosition(Parameters);
	MaterialFloat3 Local39 = LWCDdx(DERIV_BASE_VALUE(Local38));
	MaterialFloat3 Local40 = (((MaterialFloat3)0.00000000) - DERIV_BASE_VALUE(Local39));
	MaterialFloat Local41 = length(DERIV_BASE_VALUE(Local40));
	MaterialFloat Local42 = (Local37 / DERIV_BASE_VALUE(Local41));
	MaterialFloat2 Local43 = abs(Local29);
	MaterialFloat2 Local44 = (Local43 - ((MaterialFloat2)0.00000000));
	MaterialFloat Local45 = length(Local44);
	MaterialFloat3 Local46 = LWCDdy(DERIV_BASE_VALUE(Local38));
	MaterialFloat3 Local47 = (((MaterialFloat3)0.00000000) - DERIV_BASE_VALUE(Local46));
	MaterialFloat Local48 = length(DERIV_BASE_VALUE(Local47));
	MaterialFloat Local49 = (Local45 / DERIV_BASE_VALUE(Local48));
	MaterialFloat Local50 = max(Local42,Local49);
	MaterialFloat3 Local51 = mul(MaterialFloat3(0.00000000,0.00000000,1.00000000), (MaterialFloat3x3)(ResolvedView.ViewToTranslatedWorld));
	MaterialFloat3 Local52 = Local51;
	MaterialFloat Local53 = dot(Local52,Parameters.CameraVector);
	MaterialFloat Local54 = abs(Local53);
	MaterialFloat Local55 = (Local50 / Local54);
	MaterialFloat Local56 = (Local34 / Local55);
	...
	PixelMaterialInputs.Specular = Local14;
	PixelMaterialInputs.Roughness = Local13;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local3.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local11.b;
	PixelMaterialInputs.Refraction = 0;
	PixelMaterialInputs.PixelDepthOffset = Local56;
