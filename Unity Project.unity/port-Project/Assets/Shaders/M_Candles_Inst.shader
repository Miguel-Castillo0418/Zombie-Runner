...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(3.000000,3.000000,3.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(3.000000,3.000000,0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	...
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 2);
	...
	MaterialFloat Local15 = (Local13.g * Material.PreshaderBuffer[4].x);
	MaterialFloat3 Local16 = (Local9.rgb * Material.PreshaderBuffer[6].xyz);
	MaterialFloat3 Local17 = (Local16 * ((MaterialFloat3)Material.PreshaderBuffer[6].w));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local17,Material.PreshaderBuffer[7].x);
	PixelMaterialInputs.AmbientOcclusion = Local13.b;
